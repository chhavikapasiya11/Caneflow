...
const ProcurementSchedule = require("../models/Procurement");
  ...
  async (req, res) => {
    try {
      ...
      const nextTokenNumber =
        lastTicket ? lastTicket.tokenNumber + 1 : 1;
...
const today = getToday();
      ...
      const arrivalWindow =
        `${windowStart.toLocaleTimeString("en-IN", {
          hour: "numeric",
          minute: "2-digit",
          hour12: true,
        })} - ${windowEnd.toLocaleTimeString("en-IN", {
          hour: "numeric",
          minute: "2-digit",
          hour12: true,
        })}`;
